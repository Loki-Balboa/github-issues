...
export type GetUsersAndReposQueryVariables = Exact<{
  usersQuery: Scalars['String'];
  reposQuery: Scalars['String'];
}>;


export type GetUsersAndReposQuery = { __typename?: 'Query', users: { __typename?: 'SearchResultItemConnection', userCount: number, edges?: Array<{ __typename?: 'SearchResultItemEdge', node?: { __typename: 'App' } | { __typename: 'Discussion' } | { __typename: 'Issue' } | { __typename: 'MarketplaceListing' } | { __typename: 'Organization' } | { __typename: 'PullRequest' } | { __typename: 'Repository' } | { __typename: 'User', databaseId?: number | null | undefined, login: string, name?: string | null | undefined, avatarUrl: any, bio?: string | null | undefined, location?: string | null | undefined } | null | undefined } | null | undefined> | null | undefined }, repos: { __typename?: 'SearchResultItemConnection', repositoryCount: number, edges?: Array<{ __typename?: 'SearchResultItemEdge', node?: { __typename: 'App' } | { __typename: 'Discussion' } | { __typename: 'Issue' } | { __typename: 'MarketplaceListing' } | { __typename: 'Organization' } | { __typename: 'PullRequest' } | { __typename: 'Repository', databaseId?: number | null | undefined, name: string, description?: string | null | undefined, stargazerCount: number, updatedAt: any, primaryLanguage?: { __typename?: 'Language', name: string, color?: string | null | undefined } | null | undefined, issues: { __typename?: 'IssueConnection', totalCount: number }, licenseInfo?: { __typename?: 'License', name: string } | null | undefined } | { __typename: 'User' } | null | undefined } | null | undefined> | null | undefined } };
...
export type GetUserDetailsQuery = { __typename?: 'Query', user?: { __typename?: 'User', login: string, name?: string | null | undefined, avatarUrl: any, followers: { __typename?: 'FollowerConnection', totalCount: number }, following: { __typename?: 'FollowingConnection', totalCount: number }, starredRepositories: { __typename?: 'StarredRepositoryConnection', totalCount: number } } | null | undefined };


export const GetUsersAndReposDocument = gql`
...
/**
 * __useGetUsersAndReposQuery__
 *
 * To run a query within a React component, call `useGetUsersAndReposQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUsersAndReposQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUsersAndReposQuery({
 *   variables: {
 *      usersQuery: // value for 'usersQuery'
 *      reposQuery: // value for 'reposQuery'
 *   },
 * });
 */
export function useGetUsersAndReposQuery(baseOptions: Apollo.QueryHookOptions<GetUsersAndReposQuery, GetUsersAndReposQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetUsersAndReposQuery, GetUsersAndReposQueryVariables>(GetUsersAndReposDocument, options);
      }
export function useGetUsersAndReposLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUsersAndReposQuery, GetUsersAndReposQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetUsersAndReposQuery, GetUsersAndReposQueryVariables>(GetUsersAndReposDocument, options);
        }
export type GetUsersAndReposQueryHookResult = ReturnType<typeof useGetUsersAndReposQuery>;
export type GetUsersAndReposLazyQueryHookResult = ReturnType<typeof useGetUsersAndReposLazyQuery>;
export type GetUsersAndReposQueryResult = Apollo.QueryResult<GetUsersAndReposQuery, GetUsersAndReposQueryVariables>;
